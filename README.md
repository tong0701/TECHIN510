...
Negotiable — to be finalized with the assigned developer. Likely candidates:

- **Next.js + Supabase** (multi-user auth, file storage, real-time DB)
- **Python + Streamlit** (rapid prototyping, strong AI ecosystem)

Final decision recorded in `ARCHITECTURE.md`.
...
| `ARCHITECTURE.md` | Technical architecture (created by developer after matching) |
...
└── ARCHITECTURE.md     # Technical architecture (TBD — created by developer)
```
